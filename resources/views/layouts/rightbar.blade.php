            ...
            <nav class="horizontal-nav mobile-navbar fixed-navbar">
                <div class="collapse navbar-collapse" id="navbar-menu">
                  <ul class="horizontal-menu">
                    ...
                    <li class="dropdown">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/user.svg" class="img-fluid" alt="layouts"><span>Users</span></a>
                        <ul class="dropdown-menu">
                            <li><a>User 1</a></li> 
                            <li><a>User 2</a></li>
                            <li><a>User 3</a></li>
                    ...
                    <!-- <li class="dropdown">
                        <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Layouts</span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{url('/../light-vertical/')}}">Light - Vertical</a></li> 
                            <li><a href="{{url('/')}}">Light - Horizontal</a></li>
