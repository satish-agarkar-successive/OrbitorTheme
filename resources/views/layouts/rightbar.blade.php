                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                  <ul class="horizontal-menu">
                    ...
                    <li class="scroll dropdown">
                        <a href="/home" ><img src="assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Dashboard</span></a>
                    </li>
                    
                    <li class="dropdown">
                        <a href="/user" ><img src="assets/images/svg-icon/user.svg" class="img-fluid" alt="layouts"><span>Users</span></a>
                    </li> 

                    <li class="dropdown">
                        <a href="/properties" ><img src="assets/images/svg-icon/tables.svg" class="img-fluid" alt="layouts"><span>Properties</span></a>
                    </li>
